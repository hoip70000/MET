...
interface CollapsiblePanelProps {
  ...
  /** The Layers panel: no collapse/maximize of its own, always expanded and filling remaining
   *  column space with its own internal scroll — matches its "never fully hide the list" design. */
  grow?: boolean;
